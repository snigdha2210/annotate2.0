...
for video in range(6, 9):
    print("Creating Dataframe")

    directory = "5000_probed/scores_" + str(video)
    ...
    for i in range(len(allValence)):
        with open(f'5000_probed_added/scores_{video}/sub_{subjectsOrder[i]}_scores.csv', mode='w') as file:
